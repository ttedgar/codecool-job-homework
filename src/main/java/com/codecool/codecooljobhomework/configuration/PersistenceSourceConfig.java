package com.codecool.codecooljobhomework.configuration;
...
@EnableJpaRepositories(
        basePackages = "com.codecool.codecooljobhomework.repository.source",
...
public class PersistenceSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean sourceEntityManager() {
        ...
        em.setPackagesToScan("com.codecool.codecooljobhomework.entity.source");
